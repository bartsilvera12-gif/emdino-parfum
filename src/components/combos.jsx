        ...
        <div className="pmodal-info">
          ...
          <div className="pmodal-foot">
            ...
            <div className="pmodal-acts">
              <button className={"btn yellow add-btn" + (added ? " added" : "")} onClick={handleAdd}>{added ? "Agregado ✓" : "Agregar al carrito"}</button>
              <a className="btn outline-dark" href={kWa(waComboMessage(combo.nombre))} target="_blank" rel="noopener">Consultar por WhatsApp</a>
            </div>
          </div>
        </div>
      </div>
