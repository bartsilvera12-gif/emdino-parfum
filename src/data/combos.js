...
const combos = [
  ...
  },
  {
    id: "combo-elite",
    nombre: "Élite",
    tagline: "Diseñador, de pura firma",
    items: ["versace-eros", "armani-swy-intensely", "ysl-y-edp"],
    incluye: ["Versace Eros", "SWY Intensely", "YSL Y EDP"],
    presentacion: "3 decants · 5 ml",
    precioNormal: 183000,
    precioPromo: 172000,
    promoPendiente: true,
  },
  {
    id: "combo-oud-royale",
    nombre: "Oud Royale",
    tagline: "Lujo árabe, dulce y oscuro",
    items: ["lattafa-khamrah", "lattafa-asad", "rasasi-hawas-black"],
    incluye: ["Lattafa Khamrah", "Lattafa Asad", "Hawas Black"],
    presentacion: "3 decants · 5 ml",
    precioNormal: 125000,
    precioPromo: 116000,
    promoPendiente: true,
  },
  {
    id: "combo-vertigo",
    nombre: "Vértigo",
    tagline: "Noche intensa y magnética",
    items: ["jpg-le-male-elixir", "pr-invictus-victory-elixir", "versace-eros-flame"],
    incluye: ["JPG Le Male Elixir", "Victory Elixir", "Eros Flame"],
    presentacion: "3 decants · 5 ml",
    precioNormal: 171000,
    precioPromo: 160000,
    promoPendiente: true,
